...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        ...
        if city_name.lower() in CITY_DATA:
            ...
            #We got the name of the city to analyze data so we continue the loop.
    ...
    while month_name.lower() not in MONTH_DATA:
        month_name = input("\nWhat month would you like to filter? (E.g. Input 'all' for all months or input specific months e.g. or january, february, ... , june)\n")
        if month_name.lower() in MONTH_DATA:
            #We got the name of the month to analyze.
            month = month_name.lower()
        else:
            #We did not get the month to analyze data hence we continue the loop.
    ...
    while day_name.lower() not in DAY_DATA:
        ...
        if day_name.lower() in DAY_DATA:
            ...
            #We did not get the correct input of day to analyze hence we continue loop.
